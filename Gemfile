...
gem "jbuilder"
# Connect to external apis [https://github.com/jnunemaker/httparty]
gem 'httparty'
...
group :development, :test do
  ...
  # Loads environment variables from .env into ENV in development [https://github.com/bkeepers/dotenv]
